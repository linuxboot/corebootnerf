...
CONFIG_INITRAMFS_SOURCE="initramfs.linux_amd64.cpio.xz"
...
CONFIG_CMDLINE="earlyprintk=serial,ttyS0,57600 console=ttyS0,57600"
...
# CONFIG_BOARD_EMULATION_QEMU_RISCV is not set
...
# CONFIG_HAVE_INTEL_FIRMWARE is not set
